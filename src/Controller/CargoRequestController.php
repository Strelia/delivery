...
//    }
//
//    #[Route('/{id}', name: 'change_status', methods: ['GET'])]
//    public function changeStatus(Request $request, Registry $registry, CargoRequest $cargoRequest): Response
//    {
//        $workflow = $registry->get($cargoRequest, 'cargo_request');
//        try {
