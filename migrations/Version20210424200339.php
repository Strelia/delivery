...
final class Version20210424200339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cargo (id INT NOT NULL, owner_id INT NOT NULL, adr_id INT DEFAULT NULL, packaging_kind_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, weight INT NOT NULL, volume INT DEFAULT NULL, length INT DEFAULT NULL, width INT DEFAULT NULL, diameter INT DEFAULT NULL, count_belt INT DEFAULT NULL, address_from VARCHAR(255) NOT NULL, address_to VARCHAR(255) NOT NULL, has_hitch BOOLEAN DEFAULT \'false\' NOT NULL, has_ruber_tyres BOOLEAN DEFAULT \'false\' NOT NULL, has_hook BOOLEAN DEFAULT \'false\' NOT NULL, is_tir BOOLEAN DEFAULT \'false\' NOT NULL, is_cmr BOOLEAN DEFAULT \'false\' NOT NULL, is_t1 BOOLEAN DEFAULT \'false\' NOT NULL, date_start_min DATE NOT NULL, date_start_max DATE NOT NULL, price INT NOT NULL, payment_kind VARCHAR(150) NOT NULL, is_vat BOOLEAN DEFAULT \'false\' NOT NULL, prepayment_kind VARCHAR(150) DEFAULT NULL, prepayment INT DEFAULT NULL, is_hidden_user_request BOOLEAN DEFAULT \'false\' NOT NULL, status VARCHAR(15) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cargo_request DROP CONSTRAINT FK_33E8DBB08ABD09BB');
        ...
        $this->addSql('ALTER TABLE cargo_request DROP CONSTRAINT FK_33E8DBB0813AC380');
